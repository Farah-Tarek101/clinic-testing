...
WebUI.click(findTestObject('Object Repository/Page_Vite  React/a_Settings'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Vite  React/select_englisharabicfrench'), 'ar', true)
