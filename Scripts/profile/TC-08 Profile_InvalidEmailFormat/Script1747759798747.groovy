...
WebUI.click(findTestObject('Object Repository/Page_Vite  React/form_PatientAdminDoctorLogin'))
...
WebUI.setText(findTestObject('Object Repository/Page_Vite  React/input_Email_email'), 'farah.tarek1111@msa.edu.eg')
