...
WebUI.click(findTestObject('Object Repository/Page_Vite  React/div_User DetailsName Email Phone Date of Bi_8b3842'))

WebUI.setText(findTestObject('Object Repository/Page_Vite  React/input_Email_email'), 'farahtarek707@gmail.com')
